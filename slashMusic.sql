...
CREATE TABLE Lista(
    ...
    nombre_lista VARCHAR(20) NOT NULL UNIQUE,
...
CREATE TABLE Contener (
    ...
    CONSTRAINT FK_Contener_Lista_Usuario FOREIGN KEY (usuario)
    REFERENCES Lista (usuario),
    CONSTRAINT FK_Contener_Lista_Lista FOREIGN KEY (nombre_lista)
    REFERENCES Lista (nombre_lista),
