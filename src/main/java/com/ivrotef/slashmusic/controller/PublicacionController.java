...
public class PublicacionController {
    ...
    @RequestMapping(value = "/hacer_publicacion/canciones", method = RequestMethod.GET)
    public ModelAndView verCanciones () {

    }

    /* El usuario actual selecciona la canción que quiere publicar. */
    @RequestMapping(value = "/hacer_publicacion/canciones/{nombreCancion}", method = RequestMethod.GET)
