...
public class PublicacionCompartidaService {
    ...
    public ArrayList<PublicacionCompartida> obtenerPCCorreo (String correo_usuario) {
        Query query = entityManager.createQuery("FROM PublicacionCompartida p WHERE p.usuarioPC.correo =: correo", PublicacionCompartida.class);
    ...
    public ArrayList<PublicacionCompartida> obtenerPCPublicacion (int id_publicacion) {
        Query query = entityManager.createQuery("FROM PublicacionCompartida p WHERE p.publicacionCompartidaID.idPublicacion =: id", PublicacionCompartida.class);
